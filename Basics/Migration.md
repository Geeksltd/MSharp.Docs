...
- If your new app is a monolithm add a NuGet reference to Olive.Email package
  ...
  - If your new app is a Microservice, remove ApplicationEvent type. Logging is handled centrally in Microservices (in Audit service).
